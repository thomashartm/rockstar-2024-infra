...
variable "task_policy_attachments" {
  type = map(any)
  description = "Policy Attachment arns which need to be attached to each task policy to enable the task for it's purpose"
}

variable "task_execution_policy_attachments" {
  type = map(any)
  description = "Policy Attachment arns which need to be attached to each task execution policy to enable the task for it's purpose"
}
